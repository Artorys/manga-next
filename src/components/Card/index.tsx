...
export function Card(props : IPropsCard){
    return (
        <Flex flexDirection={"column"} position={"relative"} width={"150px"} maxWidth={"150px"} height={"260px"}>
            ...
            <Flex  direction={"column"} gap={"0.2rem"} paddingLeft={"1.125rem"} width={"100%"} paddingTop={"0.375rem"} bg={"greyScale.whiteFixed"} justifyContent={"flex-start"} alignItems={"center"}>
